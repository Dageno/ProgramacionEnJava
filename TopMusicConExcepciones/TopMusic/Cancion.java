...
public class Cancion {
	...
	static Cancion getInstance(String titulo, String artista, int annoGrabacion ) throws CancionNoValidaException{
		...
		if(!(Pattern.matches("[1-2]\\d{3}", cadena)&& calendario.get(Calendar.YEAR)>annoGrabacion&& Pattern.matches("\\w+", titulo) && Pattern.matches("\\w+", artista)))
			throw new CancionNoValidaException("Ha ocurrido un error y no se ha podido crear la canción.");
